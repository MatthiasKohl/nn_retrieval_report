...
These features are $L2$-normalized, then a fully connected layer
is introduced to reduce the feature dimension and the features are
$L2$-normalized again. This is similar to the architecture of
Schroff et al~\cite{schroff_facenet:_2015}, too.

We also omit the scaling+shifting layer of
Gordo et al~\cite{gordo_deep_2016} since we cannot clearly
understand the motivation behind this layer (TODO find out).
...
the most: only region pooling and shifting of the features is omitted.
