...
l'analyse des avantages et inconv\'enients du syst\`eme
...
avec l'architecture de l'\'etat de l'art,
et l'\'evaluation de la performance des diff\'erentes
approches. Nous montrons ainsi que l'architecture propos\'ee donne des
r\'esultats performants tout en \'etant rapide \`a \'evaluer et raisonnablement
rapide \`a mettre en place pour une nouvelle collection de mus\'ee ou site
touristique. L'\'evaluation se fait sur les deux corpus d'images CLICIDE
et GaRoFou, tous deux typiques de corpus d'images disponibles pour un
mus\'ee, contenant des images de leurs \oe{}uvres d'art.
\end{abstract}
