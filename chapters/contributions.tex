...
The main difference between image classification and image retrieval is the amount of data and their variability. In classification, we rely on large amounts of data, with high inter-class variability. This allows us to train a deep CNN with millions of parameters. In image retrieval or identification, as we want to identify a particular instance, the variability of examples of that instance is less important. This means the data is usually not sufficient to train a network like ResNet.
