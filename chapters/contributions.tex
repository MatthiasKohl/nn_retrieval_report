...
= \frac{1}{N} \sum_{i=1}^N \mathcal{CE}_i
\end{equation}
...
$\mathcal{CE}^{h,w}$ represents the cross-entropy loss applied
...
\sum_{h=1}^{H_s} \sum_{w=1}^{W_s} \mathcal{CE}^{h,w}
\end{equation}
...
\alpha \frac{1}{N} \frac{1}{k} \sum_{l=1}^k \mathcal{CE}_i^{h_l,w_l} \right)
\end{equation}
